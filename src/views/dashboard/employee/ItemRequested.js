...
export default function AreaRequested() {
  ...
  const columns = [
    ...
    { id: "month", label: "Month", minWidth: 60, align: "center" },
  ...
  function createData(num, Date, month, location, status, farmerName) {
    return { num, Date, month, location, status, farmerName };
  }
    ...
    <div>
      <Grid container spacing={0}>
        <Grid item xs={12} sm={12} md={6} lg={9}>
          <h1 className="nb-title">Item Requested List</h1>
        </Grid>
